  ...
  return (
    <footer className="border-t border-border bg-card-bg transition-colors duration-300">
      <div className="mx-auto max-w-7xl px-6 py-12 md:px-8 lg:py-16">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div className="space-y-4 xl:col-span-1">
            <Link href="/" className="flex items-center gap-2.5">
              <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-tr from-emerald-500 via-teal-500 to-green-600 shadow-md">
                <Trophy className="h-5 w-5 text-white" />
              </div>
              <span className="font-bold text-foreground text-base tracking-wide">WorldCupX</span>
            </Link>
            <p className="text-xs text-muted max-w-sm leading-relaxed">
              WorldCupX is a state-of-the-art sports analytics platform utilizing advanced AI models to forecast FIFA World Cup matches, analyze national squad tactics, and provide insights.
            </p>
          ...
          <div className="mt-12 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0 md:grid-cols-3">
            <div>
              ...
              <ul role="list" className="mt-4 space-y-2.5">
                ...
                <li>
                  <Link href="/documents" className="text-xs text-muted hover:text-foreground transition-colors font-semibold text-emerald-400">
                    Explore Teams
                  </Link>
                </li>
                <li>
        ...
        <div className="pt-8 border-t border-border flex flex-col md:flex-row items-center justify-between text-xs text-muted font-medium gap-4">
          <p>
            &copy; {currentYear} WorldCupX. All rights reserved. Created using Next.js, Express, and Gemini.
          </p>
          <p className="text-xs text-muted text-center md:text-right">
            Designed for professional football analysis and forecasting.
          </p>
        </div>
      </div>
    </footer>
